...
const strategy = new GoogleStrategy(
	{
		clientID: process.env.GOOGLE_CLIENT_ID || '155017138163-lapght4pn915qcn24ha85h9tm2te2ihq.apps.googleusercontent.com',
		clientSecret: process.env.GOOGLE_CLIENT_SECRET || 'HDjItQ9jJbyg5XWpY1WG-_A1',
